...
public:
    ...
    enum class Number : uint8_t {
		...
		ROLQUAD   =   27,  // Code Quad rol //RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR
    };
...
private:
    ...
    //Ganancias para la altura y posicion
     ...
     //Bandera de activación para la altura
     bool flag_spz = true;

     //Bandera para ubicar la posición
     bool flag_spxy = true;
